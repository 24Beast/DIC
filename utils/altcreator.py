...
# Data Class
class MaskCaptionGenderDataset:
    def __init__(self, human_ann_file: pathType, model_ann_file: pathType) -> None:
        ...
        with open(model_ann_file, "r") as f:
    ...
    def processData(self) -> None:
        ...
        for item in self.model_data:
            self.model_ann["img_id"].append(int(item["image_id"].split(".")[0]))
            self.model_ann["caption"].append(item["caption"])
